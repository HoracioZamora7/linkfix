...
--
-- Host: localhost    Database: linkfix
-- ------------------------------------------------------
...
--
-- Table structure for table `aud_usuariohistorial`
--

DROP TABLE IF EXISTS `aud_usuariohistorial`;
...
CREATE TABLE `aud_usuariohistorial` (
  ...
  `emailTokenFechaExpiracion` datetime DEFAULT NULL,
  `fechaUltimaEdicion` datetime DEFAULT NULL,
  `idUsuarioUltimaEdicion` bigint(20) DEFAULT NULL,
...
--
-- Dumping data for table `aud_usuariohistorial`
--

LOCK TABLES `aud_usuariohistorial` WRITE;
/*!40000 ALTER TABLE `aud_usuariohistorial` DISABLE KEYS */;
INSERT INTO `aud_usuariohistorial` VALUES (1,1,'horaciozamora77@gmail.com',1,'2025-06-13 15:27:14','89e0cc1f-cafa-41e1-93eb-ced80d6bbcc9','2025-06-13 15:28:14',NULL,NULL,1,'HORACIO HUMBERTO','ZAMORA HUAYAMARES','72837669',NULL,'180103','942096211','Av Las Palmas Condominio Villa Riviera S/N','2025-06-13 15:27:39');
/*!40000 ALTER TABLE `aud_usuariohistorial` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `dia` VALUES (7,'Domingo'),(4,'Jueves'),(1,'Lunes'),(2,'Martes'),(3,'Miercoles'),(6,'Sábado'),(5,'Viernes');
...
CREATE TABLE `disponibilidad` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_disponibilidad_usuario` (`idTecnico`),
...
CREATE TABLE `especialidad` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `idTecnico` bigint(20) NOT NULL,
  `idElectrodomestico` bigint(20) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_especialidad_usuario` (`idTecnico`),
...
INSERT INTO `estado` VALUES (1,'Activo'),(5,'Correo no confirmado'),(2,'Inactivo'),(3,'Pendiente de aprobación'),(4,'Rechazado');
...
CREATE TABLE `incidencia` (
  ...
  `idEstado` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_incidencia_usuario` (`idUsuario`),
  KEY `fk_incidencia_servicio` (`idServicio`),
  KEY `fk_incidencia_admin` (`idAdministrador`),
  KEY `fk_incidencia_estado` (`idEstado`),
  CONSTRAINT `fk_incidencia_admin` FOREIGN KEY (`idAdministrador`) REFERENCES `usuario` (`id`),
  CONSTRAINT `fk_incidencia_estado` FOREIGN KEY (`idEstado`) REFERENCES `estado` (`id`),
  CONSTRAINT `fk_incidencia_servicio` FOREIGN KEY (`idServicio`) REFERENCES `servicio` (`id`),
  CONSTRAINT `fk_incidencia_usuario` FOREIGN KEY (`idUsuario`) REFERENCES `usuario` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `persona` VALUES (1,'HORACIO HUMBERTO','ZAMORA HUAYAMARES','72837669',NULL,'180103','942096211','Av Las Palmas Condominio Villa Riviera S/N');
...
INSERT INTO `rol` VALUES (1,'Administrador'),(2,'Cliente'),(3,'Técnico');
...
CREATE TABLE `servicio` (
  ...
  KEY `fk_servicio_electro` (`idElectrodomestico`),
  KEY `fk_servicio_estado` (`idEstado`),
  CONSTRAINT `fk_servicio_cliente` FOREIGN KEY (`idCliente`) REFERENCES `usuario` (`id`),
...
--
-- Table structure for table `solicitudregistro`
--

DROP TABLE IF EXISTS `solicitudregistro`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `solicitudregistro` (
  ...
  KEY `fk_solicitud_admin` (`idAdmin`),
  CONSTRAINT `fk_solicitud_admin` FOREIGN KEY (`idAdmin`) REFERENCES `usuario` (`id`),
  CONSTRAINT `fk_solicitud_tecnico` FOREIGN KEY (`idTecnico`) REFERENCES `usuario` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `solicitudregistro`
--

LOCK TABLES `solicitudregistro` WRITE;
/*!40000 ALTER TABLE `solicitudregistro` DISABLE KEYS */;
/*!40000 ALTER TABLE `solicitudregistro` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ubigeodistritos`
--

DROP TABLE IF EXISTS `ubigeodistritos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ubigeodistritos` (
...
CREATE TABLE `usuario` (
  ...
  KEY `fk_usuario_estado` (`idEstado`),
  KEY `fk_usuario_usuario` (`idUsuarioUltimaEdicion`),
...
INSERT INTO `usuario` VALUES (1,1,'horaciozamora77@gmail.com','$2a$10$Nt9xsVDUyKOf7DaJ8qk/Y.Ep04RFlCcsiNb6NbMrOXusn7H752IS6',0,1,'2025-06-13 15:27:14','89e0cc1f-cafa-41e1-93eb-ced80d6bbcc9','2025-06-13 15:28:14',NULL,NULL);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER after_usuario_update
...
CREATE TABLE `usuariorol` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_UsuarioRol_usuario` (`idUsuario`),
...
INSERT INTO `usuariorol` VALUES (1,1,2),(2,1,1);
...
-- Dump completed on 2025-06-13 16:48:35
