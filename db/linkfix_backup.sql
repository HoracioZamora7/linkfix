...
--
-- Table structure for table `audusuariohistorial`
--

DROP TABLE IF EXISTS `audusuariohistorial`;
...
CREATE TABLE `audusuariohistorial` (
  ...
  `correoUsuarioUltimaEdicion` varchar(50) DEFAULT NULL,
...
--
-- Dumping data for table `audusuariohistorial`
--

LOCK TABLES `audusuariohistorial` WRITE;
/*!40000 ALTER TABLE `audusuariohistorial` DISABLE KEYS */;
/*!40000 ALTER TABLE `audusuariohistorial` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `estado` VALUES (9,'Aceptado, pero pendiente de atención'),(1,'Activo'),(6,'Cancelado'),(5,'Correo no confirmado'),(7,'Finalizado'),(2,'Inactivo'),(3,'Pendiente de aprobación'),(8,'Pendiente de confirmación'),(4,'Rechazado');
...
CREATE TABLE `servicio` (
  ...
  `idTecnico` bigint(20) NOT NULL,
  `idElectrodomestico` bigint(20) DEFAULT NULL,
